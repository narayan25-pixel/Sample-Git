...
namespace shopping
{
    ...
    class Program
    {
        ...
        static void Products()
        {
            ...
            con.ConnectionString = "data source=IN5CG9214YKN; database=shoppingCart; integrated security = true";
        ...
        static void CustomerDetail()
        {
            ...
            con1.ConnectionString = "data source=IN5CG9214YKN; database=shoppingCart; integrated security = true";
